...
#
# Generated by export_simulation on Tue Mar 31 16:57:30 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './clk_gen_sim_0.sh' script.

./clk_gen_sim_0.sh -reset_run
...
./clk_gen_sim_0.sh -noclean_files

For more information on the script, please type './clk_gen_sim_0.sh -help'.

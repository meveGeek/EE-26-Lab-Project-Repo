...
HD_PWD='Z:/ee26/lab2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log use_claa_from_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source use_claa_from_rom.tcl

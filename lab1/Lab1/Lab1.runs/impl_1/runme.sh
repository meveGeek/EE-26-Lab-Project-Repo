...
HD_PWD='Z:/ee26/lab1/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_sub.tcl -notrace

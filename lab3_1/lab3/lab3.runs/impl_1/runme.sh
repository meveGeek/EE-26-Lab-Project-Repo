...
HD_PWD='Z:/ee26/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_butterfly.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_butterfly.tcl -notrace
